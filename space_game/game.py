...
count_meteoro = []
count_explosions = []
som_fundo = pygame.mixer.Sound(os.path.join('som','DST-RailJet-LongSeamlessLoop.ogg'))
coracao_tempo = 0
...
you_win_fundo = pygame.image.load(os.path.join('fundo','youwin.fw.png'))
...
def draw():
    ...
    if bossStatus == True:
        boss_text = font.render('Boss: '+str(boss.health),1,(255,255,255))
        win.blit(boss_text,(400,0))
